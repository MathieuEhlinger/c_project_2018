...
Ceci est un script pas vraiment temporaire.
"""
...
def run_to(use_new_format=True, death_to_the_old_ways=True,remove_org_data=True):
    
    directory_data, directory_tracks, directory_stats =  'data', 'tracks', 'stats'
    directory = 'output'
    print('The One is running ...')
    ...
    if use_new_format:
        print('Modifying The One\'s output ...')
        main_new_conf(directory_data, directory_tracks,directory_stats,
